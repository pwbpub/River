     ...
     return (
        ...
        <div className='book-input-container'>
            ...
            <form onSubmit={handleSubmit}>
                <p className="find-book-subtitle"> Enter 3 Favorite Books and What You Liked About Them:</p>
                ...
                <input type="text" name="book2" placeholder='Book 2' value={bookInputs.book2} onChange={handleChange}  />
                <input type="text" name="reason2" placeholder='Why you liked it (optional)' value={bookInputs.reason2} onChange={handleChange} />

                <input type="text" name="book3" placeholder='Book 3' value={bookInputs.book3} onChange={handleChange}  />
